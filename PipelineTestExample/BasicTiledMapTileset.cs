...
namespace PipelineTestExample
{
    public class BasicTiledMapTileset
    {
        ...
        /// The Map's Layers
        /// </summary>
        public Dictionary<string, BasicParallelTiledLayer> Layers { get; set; }

        /// <summary>
        /// The Map's Tilesets
        /// </summary>
        public Dictionary<string, BasicParallelTileset> Tilesets { get; set; }
    }
    ...
    public class BasicParallelTiledLayer
    {
